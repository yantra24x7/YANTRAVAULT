(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["Components-login-login-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsLoginDialogHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppComponentsLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _Service_app_login_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    ...
    let LoginComponent = class LoginComponent {
      ...
      logintest(val) {
        ...
        this.service.signin(val).subscribe(res => {
          ...
          localStorage.setItem('email', res.user.email_id); // localStorage.setItem('password',res.user.password)
        });
      }
    ...
    Dialog = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/Components/login/dialog.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./login.component.scss */
      "./src/app/Components/login/login.component.scss")).default]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__param"](1, Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"])(_angular_material_dialog__WEBPACK_IMPORTED_MODULE_3__["MAT_DIALOG_DATA"]))], Dialog);
    /***/
  },
  ...
  function srcAppComponentsLoginLoginModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _Service_app_login_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ../../Service/app/login.service */
    "./src/app/Service/app/login.service.ts");
